    ...
    `);
      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-4e0abce0.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
      ...
      */
      ...
      register('video', {
        ...
        onLoad() {
          module.import('./fluorescent-video.es-482b6150.nomodule.js').then(({
            default: Video
          }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-e204114d.nomodule.js').then(({
          default: filtering
        }) => {
      ...
      window.SHA = 'b3c75efdb1';

    })
  };
}));
//# sourceMappingURL=theme-5a3ec1c8.nomodule.js.map
