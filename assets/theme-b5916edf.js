...
register('announcement-bar', {
  ...
  onLoad() {
    ...
    if (announcements.length > 1) {
      import('./index-f13ac32d.js').then(function (n) { return n.i; }).then(({
        default: Flickity
      }) => {
...
register('video', {
  ...
  onLoad() {
    import('./fluorescent-video.es-2818f612.js').then(({
      default: Video
    }) => {
...
const filterHandler = ({
  ...
  let filters = null;
  let delegate = null;
  import('./filtering-243b4362.js').then(({
    default: filtering
  }) => {
...
//# sourceMappingURL=theme-b5916edf.js.map
